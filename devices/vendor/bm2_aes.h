// Vendored verbatim (below this header) from:
//   github://DJBenson/bm2-esphome/bm2_aes.h
// vendored-from: main @8f9e7f245aa7ab0a14a115a20e37fdbfd8571ec8
// Tracking and re-sync notes live in vendor/bm2-battery.yaml, which is what
// Renovate watches. Only this header block is ours; diff the rest against
// upstream when the digest moves.
